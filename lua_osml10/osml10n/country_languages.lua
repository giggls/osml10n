-- Initially this table is derived from
-- http://wiki.openstreetmap.org/wiki/Nominatim/Country_Codes
-- using gen_country_languages_table.py
--
-- However it needed to get adapted for map rendering purposes!
-- This means"," that more than three additional languages are not
-- feasible to use.
--
